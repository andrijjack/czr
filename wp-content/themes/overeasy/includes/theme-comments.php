...
<li class="comment wrap threaded" id="comment-<?php comment_ID() ?>">
    ...
    <div class="col1 ar">
        ...
        <div><?php comment_author_link() ?><br /><?php comment_date('d.m.Y') ?><br /><?php edit_comment_link('Редагувати','',''); ?>
		<?php echo comment_reply_link(array('before' => '<span class="reply">', 'after' => '</span>', 'reply_text' => 'Відповісти', 'depth' => $depth, 'max_depth' => $args['max_depth'] ));  ?></div>
    </div>
    <!--/col1 -->
    <div class="col2">
        <div class="box3">
            <div class="spcr">
                ...
                <em>Ваш коментар у черзі на перегляд модератором.</em>
                <?php endif; ?>
